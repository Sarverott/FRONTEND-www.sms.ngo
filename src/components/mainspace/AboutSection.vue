...
<template>
    <section class="content is-normal">
        ...
        <h2>About Us</h2>
        <p>
            Welcome to Silesia Maker Space! We are dedicated to fostering creativity, innovation, and collaboration in
            our community.
        </p>
        <p>
        ...
        <h2>Second Us because... No ideas, just keep going please</h2>
        <p>
